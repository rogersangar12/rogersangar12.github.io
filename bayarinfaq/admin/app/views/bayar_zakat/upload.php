            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="<?= BASEURL; ?>/bayar_zakat/ubahmuzakki" method="post">
                            <input type="hidden" name="id" value="<?= $data['bayar_zakat']['id']; ?>">
                            <div class="mb-3 row">
                                <label for="nama" class="col-sm-3 col-form-label">No. Kartu Keluarga</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="no_kk" placeholder="3206192045678902" id="nama" value="<?= $data['bayar_zakat']['no_kk']; ?>" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <select id="keterangan" name="keterangan" class="form-select" value="<?= $data['bayar_zakat']['keterangan']; ?>" required>
                                        <option value='<?= $data['bayar_zakat']['keterangan']; ?>'><?= $data['bayar_zakat']['keterangan']; ?></option>
                            ...
                            <div class="mb-3 row">
                                <a href="<?= BASEURL; ?>/bayar_zakat/index/" class="btn btn-danger">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
