...
class Printer1
{
    public static function Print1($data)
    {
        $date = date('d F Y');
        $mpdf = new \Mpdf\Mpdf();
        $html = '
        ...
        <body>
            ...
            <hr class="line">
            <div class="title">
                INFORMASI SALDO INFAQ MIFTAHUL KHOER
            </div>
            <div class="content">
                <p>Dengan dikeluarkannya laporan ini kami selaku DKM Mesjid Miftahul Khoer
                memberitahukan bahwa hasil dari pengelolaan infaq adalah sebagai
                berikut :</p>
            </div>
            <div class="content">
        <p style="font-weight: bold; ">A.	INFORMASI PEMASUKAN INFAQ</p>
    </div>
            <table class="table">
            <thead>
                <tr>
        ...
        foreach ($data['bayar_infaq'] as $bayar_infaq) {
            $html .= '
                    <tr>
                        <td>' . $i . '</td>
        ...
        <div class="content">
        <p style="font-weight: bold; ">B.	PENGELUARAN INFAQ</p>
    </div>
    <table class="table">
            <thead>
                <tr>
            ...
            <tbody>';
        $i = 1;
        foreach ($data['pengeluaran_infaq'] as $pengeluaran_infaq) {
            $html .= '
                    <tr>
                        <td>' . $i . '</td>
        ...
        <div class="content">
        <p style="font-weight: bold; ">C.	TOTAL PEMASUKAN DAN PENGELUARAN</p>
    </div>
    <table class="table">
            <thead>
                <tr>
        ...
        // $i = 1;
        // foreach ($data['pengeluaran_infaq'] as $pengeluaran_infaq) {
        // var_dump($data['total_infaq'][0]['jumlah']);
        // die;
        $html .= '
                    <tr>
                        <td>' . $data['total_infaq'][0]['jumlah'] . '</td>
                        <td>' . $data["total_pengeluaran"][0]['jumlah'] . '</td>
                        <td>' . $data['total_infaq'][0]['jumlah'] - $data["total_pengeluaran"][0]['jumlah'] . '</td>
                    </tr>';
        // $i++;
        // }
        ...
        <div class="content">
            <p>Demikian laporan pengelolaan infaq DKM Mesjid Miftahul Khoer ini dibuat dengan sebenar-benarnya.</p>
        </div>
        <div class="signature">
            <p>Tasikmalaya, ' . $date . '</p>
        </div>
        <div class="signature" style=" margin-top: 50px;">
            <p>Ketua DKM Miftahul Khoer</p>
        </div>
        </body>
        </html>     
';
